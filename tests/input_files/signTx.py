...
from application_client.app_def import Errors, NetworkDesc, Mainnet, Testnet
# from application_client.app_def import Testnet_legacy
...
class TxAuxiliaryDataSupplementType(IntEnum):
    CIP36_REGISTRATION = 0
...
class TxAuxiliaryDataCIP36:
    ...
    nonce: int
    voteKeyHex: Optional[str] = None
    voteKeyPath: Optional[str] = None
...
class Certificate:
    ...
    stakeCredential: Optional[CredentialParams] = None
    deposit: Optional[int] = None
    hotCredential: Optional[CredentialParams] = None
    coldCredential: Optional[CredentialParams] = None
    poolKey: Optional[str] = None
    retirementEpoch: Optional[int] = None
    dRep: Optional[DRepParams] = None
    dRepCredential: Optional[CredentialParams] = None
    anchor: Optional[AnchorParams] = None
...
@dataclass
class TxAuxiliaryDataSupplement:
    auxiliaryDataHashHex: str
    cip36VoteRegistrationSignatureHex: str
    type: TxAuxiliaryDataSupplementType = TxAuxiliaryDataSupplementType.CIP36_REGISTRATION


@dataclass
class SignedTransactionData:
    witnesses: Optional[List[Witness]] = None
    auxiliaryDataSupplement: Optional[TxAuxiliaryDataSupplement] = None
...
testsShelleyNoCertificates = [
    ...
    SignTxTestCase("Sign tx with path based withdrawal",
                   Transaction(Mainnet,
                               ...
                               42,
                               10,
                               withdrawals=[Withdrawal(CredentialParams(CredentialType.KEY_PATH,
                                                                        "m/1852'/1815'/0'/2/0"),
                                                       111)]),
                   TransactionSigningMode.ORDINARY_TRANSACTION,
    ...
    SignTxTestCase("Sign tx with a stake registration path certificate --- pre-Conway",
                   Transaction(Mainnet,
                               ...
                               certificates=[Certificate(CertificateType.STAKE_REGISTRATION,
                                                         CredentialParams(CredentialType.KEY_PATH,
                                                                          "m/1852'/1815'/0'/2/0"))]),
                   TransactionSigningMode.ORDINARY_TRANSACTION,
    ...
    SignTxTestCase("Sign tx with a stake delegation path certificate",
                   Transaction(Mainnet,
                               ...
                               certificates=[Certificate(CertificateType.STAKE_DELEGATION,
                                                         CredentialParams(CredentialType.KEY_PATH,
                                                                          "m/1852'/1815'/0'/2/0"),
                                                         poolKey="f61c42cbf7c8c53af3f520508212ad3e72f674f957fe23ff0acb4973")]),
                   TransactionSigningMode.ORDINARY_TRANSACTION,
    ...
    SignTxTestCase("Sign tx with vote delegation certificates",
                   Transaction(Mainnet,
                               ...
                               certificates=[Certificate(CertificateType.VOTE_DELEGATION,
                                                         CredentialParams(CredentialType.KEY_PATH,
                                                                          "m/1852'/1815'/0'/2/0"),
                                                         dRep=DRepParams(DRepParamsType.KEY_PATH,
                                                                         "m/1852'/1815'/0'/3/0")),
                                             Certificate(CertificateType.VOTE_DELEGATION,
                                                         CredentialParams(CredentialType.KEY_PATH,
                                                                          "m/1852'/1815'/0'/2/0"),
                                                         dRep=DRepParams(DRepParamsType.KEY_HASH,
                                                                         "7afd028b504c3668102b129b37a86c09a2872f76741dc7a68e2149c8")),
                                             Certificate(CertificateType.VOTE_DELEGATION,
                                                         CredentialParams(CredentialType.KEY_PATH,
                                                                          "m/1852'/1815'/0'/2/0"),
                                                         dRep=DRepParams(DRepParamsType.SCRIPT_HASH,
                                                                         "1afd028b504c3668102b129b37a86c09a2872f76741dc7a68e2149c8")),
                                             Certificate(CertificateType.VOTE_DELEGATION,
                                                         CredentialParams(CredentialType.KEY_PATH,
                                                                          "m/1852'/1815'/0'/2/0"),
                                                         dRep=DRepParams(DRepParamsType.ABSTAIN)),
                                             Certificate(CertificateType.VOTE_DELEGATION,
                                                         CredentialParams(CredentialType.KEY_PATH,
                                                                          "m/1852'/1815'/0'/2/0"),
                                                         dRep=DRepParams(DRepParamsType.NO_CONFIDENCE))]),
                   TransactionSigningMode.ORDINARY_TRANSACTION,
                   "",
                   SignedTransactionData([Witness("m/1852'/1815'/0'/0/0",
    ...
    SignTxTestCase("Sign tx with AUTHORIZE_COMMITTEE_HOT certificates",
                   Transaction(Mainnet,
                               ...
                               certificates=[Certificate(CertificateType.AUTHORIZE_COMMITTEE_HOT,
                                                         coldCredential=CredentialParams(CredentialType.KEY_PATH,
                                                                                         "m/1852'/1815'/0'/4/0"),
                                                         hotCredential=CredentialParams(CredentialType.KEY_PATH,
                                                                                        "m/1852'/1815'/0'/5/0")),
                                             Certificate(CertificateType.AUTHORIZE_COMMITTEE_HOT,
                                                         coldCredential=CredentialParams(CredentialType.KEY_PATH,
                                                                                         "m/1852'/1815'/0'/4/0"),
                                                         hotCredential=CredentialParams(CredentialType.KEY_HASH,
                                                                                        "1afd028b504c3668102b129b37a86c09a2872f76741dc7a68e2149c8")),
                                             Certificate(CertificateType.AUTHORIZE_COMMITTEE_HOT,
                                                         coldCredential=CredentialParams(CredentialType.KEY_PATH,
                                                                                         "m/1852'/1815'/0'/4/0"),
                                                         hotCredential=CredentialParams(CredentialType.SCRIPT_HASH,
                                                                                        "1afd028b504c3668102b129b37a86c09a2872f76741dc7a68e2149c8"))]),
                   TransactionSigningMode.ORDINARY_TRANSACTION,
    ...
    SignTxTestCase("Sign tx with DREP_REGISTRATION certificates",
                   Transaction(Mainnet,
                               ...
                               certificates=[Certificate(CertificateType.DREP_REGISTRATION,
                                                         dRepCredential=CredentialParams(CredentialType.KEY_PATH,
                                                                         "m/1852'/1815'/0'/3/0"),
                                                         anchor=AnchorParams("www.vacuumlabs.com",
                                                                             "1afd028b504c3668102b129b37a86c09a2872f76741dc7a68e2149c8deadbeef"),
                                                         deposit=19),
...
testsMultisig = [
    ...
    SignTxTestCase("Sign tx with script based withdrawal",
                   Transaction(Mainnet,
                               ...
                               42,
                               10,
                               withdrawals=[Withdrawal(CredentialParams(CredentialType.SCRIPT_HASH,
                                                                        "122a946b9ad3d2ddf029d3a828f0468aece76895f15c9efbd69b4277"),
                                                       111)]),
                   TransactionSigningMode.MULTISIG_TRANSACTION,
    ...
    SignTxTestCase("Sign tx with a stake registration script certificate",
                   Transaction(Mainnet,
                               ...
                               10,
                               certificates=[Certificate(CertificateType.STAKE_REGISTRATION,
                                                         CredentialParams(CredentialType.SCRIPT_HASH,
                                                                          "122a946b9ad3d2ddf029d3a828f0468aece76895f15c9efbd69b4277"))]),
                   TransactionSigningMode.MULTISIG_TRANSACTION,
...
testsCatalystRegistration = [
    SignTxTestCase("Sign tx with Catalyst registration metadata with base address",
                   Transaction(Mainnet,
                               ...
                               auxiliaryData=TxAuxiliaryData(TxAuxiliaryDataType.CIP36_REGISTRATION,
                                                             TxAuxiliaryDataCIP36(CIP36VoteRegistrationFormat.CIP_15,
                                                                                  "m/1852'/1815'/0'/2/0",
                                                                                  outputs["internalBaseWithStakingPath"].destination,
                                                                                  1454448,
                   ...
                   SignedTransactionData([Witness("m/1852'/1815'/0'/0/0",
                                                  ...
                                                  TxAuxiliaryDataSupplement("e9141b460aea0abb69ce113c7302c7c03690267736d6a382ee62d2a53c2ec926",
...
testsAlonzo = [
    ...
    # TODO: Debug Nano navigation (stax ok)
    ...
    #                            10,
    #                            certificates=[Certificate(CertificateType.STAKE_DELEGATION,
    #                                                      CredentialParams(CredentialType.KEY_HASH,
    #                                                                       "29fb5fd4aa8cadd6705acc8263cee0fc62edca5ac38db593fec2f9fd"),
    #                                                      poolKey="f61c42cbf7c8c53af3f520508212ad3e72f674f957fe23ff0acb4973")],
    #                            withdrawals=[Withdrawal(CredentialParams(CredentialType.KEY_HASH,
    #                                                                     "29fb5fd4aa8cadd6705acc8263cee0fc62edca5ac38db593fec2f9fd"),
    #                                                    1000)],
    #                            includeNetworkId=True),
    #                TransactionSigningMode.PLUTUS_TRANSACTION,
...
testsBabbage = [
    ...
    #                Transaction(NetworkDesc(Testnet_legacy,
    #                            [inputs["utxoShelley"]],
     ...
     SignTxTestCase("Reject tx with invalid canonical ordering of withdrawals",
                   Transaction(Mainnet,
                               ...
                               withdrawals=[Withdrawal(CredentialParams(CredentialType.KEY_PATH,
                                                                        "m/1852'/1815'/0'/2/1"),
                                                       33333),
                                            Withdrawal(CredentialParams(CredentialType.KEY_PATH,
                                                                        "m/1852'/1815'/0'/2/0"),
                                                       33333)]),
                   TransactionSigningMode.ORDINARY_TRANSACTION,
                   "",
