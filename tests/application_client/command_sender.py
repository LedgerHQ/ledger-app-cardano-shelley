...
from input_files.signTx import SignTxTestCase, TxInput, TxOutput, TxAuxiliaryData, TxAuxiliaryDataCIP36
...
class CommandSender:
    ...
    @contextmanager
    def sign_tx_aux_data_hash(self, auxData: TxAuxiliaryData) -> Generator[None, None, None]:
        """APDU Sign TX - AUX_DATA step - ARBITRARY_HASH mode
        ...
        with self._exchange_async(self._cmd_builder.sign_tx_aux_data_hash(auxData)):
            yield
    ...
    def sign_tx_collateral_output_confirm(self) -> RAPDU:
        ...
        return self._exchange(self._cmd_builder.sign_tx_collateral_output_confirm())
